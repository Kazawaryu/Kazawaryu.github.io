...
- First order necessary condition: let $$x^*$$ to be a local minimum, then $$\nabla f(x^*)=0$$
- Second order necessary condition: let $$x^*$$ to be a local minimum, then $$\nabla^2 f(x^*)\succeq 0$$, which is positive semi-definite.
- Second order sufficient condition: let $$x^*$$ to be a local minimum, then $$\nabla f(x^*)=0$$ and $$\nabla^2 f(x^*)\succ 0$$, which is positive definite.
